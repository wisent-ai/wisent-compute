...
_REGISTRY = [
    ...
    {"name": "stado_artifact_list", "cli": ["artifact", "list", "--json"],
     ...
     "arg": {"name": "type", "required": False,
             "flag": "--type", "desc": "Optional artifact type filter."}},
    {"name": "stado_artifact_show", "cli": ["artifact", "show", "--json"],
    ...
    {"name": "stado_artifact_resolve", "cli": ["artifact", "resolve", "--json"],
     "desc": "Resolve an artifact alias to an immutable version (read-only).",
     "arg": {"name": "ref", "required": True,
             "desc": "Artifact version or alias reference."}},
    {"name": "stado_artifact_verify", "cli": ["artifact", "verify", "--json"],
     "desc": "Re-run generic and type-specific artifact verification (read-only).",
     "arg": {"name": "ref", "required": True,
             "desc": "Artifact version or alias reference."}},
    {"name": "stado_artifact_lineage", "cli": ["artifact", "lineage", "--json"],
